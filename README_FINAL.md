...
Pour lancer le jeu, il faut executer les commandes suivantes depuis la racine du projet (AbignoliDebbah) :

- Terminal :

java -cp ./target/Catane-0.0.1-SNAPSHOT.jar com.catane.launcher.Launcher

- GUI :

java -cp ./target/Catane-0.0.1-SNAPSHOT.jar com.catane.launcher.Launcher gui
